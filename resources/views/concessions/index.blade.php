...
<table class="table table-striped table-bordered">
    ...
    @foreach($concessions as $key => $value)
        <tr>
            ...
            <td>{{ $value->status }}</td>
            <td>
                <a class="btn btn-small btn-success" href="{{ URL::to('concessions/' . $value->id) }}"><i class="fa fa-search"></i></a>
                <a class="btn btn-small btn-info" href="{{ URL::to('concessions/' . $value->id . '/edit') }}"><i class="fa fa-pencil-square-o"></i></a>
